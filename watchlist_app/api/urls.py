...
urlpatterns = [
    ...
    path('movie-details/<uuid:pk>', views.WatchDetailAV.as_view(), name='movie-details'),
    
    path('stream-platform', views.StreamPlatformAV.as_view(), name='stream-platform'),
    
    path('stream-platform-detail/<uuid:pk>', views.StreamPlatformDetailsAV.as_view(), name='stream-platform-detail'),
